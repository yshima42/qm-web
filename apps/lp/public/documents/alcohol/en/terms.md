...
These Terms of Service ("Terms") govern your access to and use of the Alcohol-Free Week mobile application and related services (collectively, the "Service") operated by Alcohol-Free Week ("we", "us", or "our"). By using the Service, you agree to be bound by these Terms. If you do not agree, you may not use the Service.

## 1. Scope of These Terms

These Terms apply to all interactions between you (the "User") and Alcohol-Free Week related to the Service. Additional rules or guidelines ("Additional Terms") may also apply, and such rules shall be considered part of these Terms. In the event of a conflict, the Additional Terms shall take precedence unless otherwise stated.
...
Alcohol-Free Week explicitly prohibits all forms of Child Sexual Abuse and Exploitation (CSAE) and Child Sexual Abuse Material (CSAM).
...
If any of the above actions are detected, Alcohol-Free Week may take the following actions:
...
Alcohol-Free Week complies fully with Google Play's Child Safety standards and all applicable laws concerning child protection.
...
Users may only post or upload content (text, images, videos) to which they own rights or have proper authorization. The rights to such content remain with the user or rightful owner, but you grant Alcohol-Free Week a non-exclusive license to use it for purposes such as improving or promoting the Service.

All other content and intellectual property related to the Service belongs to Alcohol-Free Week or its licensors. Users may not reproduce, distribute, alter, or publicly share such materials without prior written consent.
...
All notices and communication between you and Alcohol-Free Week shall be conducted via methods we specify (e.g., in-app notification, email). Notices are deemed delivered when sent to your registered contact information.

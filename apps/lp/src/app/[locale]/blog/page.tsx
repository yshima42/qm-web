  ...
  return (
    <div className="min-h-screen bg-[#f8fbf7]">
      ...
      <div className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-8 pb-6 sm:px-6 sm:py-12 sm:pb-8 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center md:max-w-3xl">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-lg text-gray-500 sm:text-xl">

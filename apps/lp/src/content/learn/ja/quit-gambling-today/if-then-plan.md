...
required: false
excerpt: "午前9時半。 保育園に息子を預けてきた。 家に戻ると、夕方のお迎えまで誰もいない。"
...
ところが、子供を預けたあとの昼間の空白時間、一人きりの家の中。
朝に決めた自分はもう、そこにはいない。
...
これだけで、目標を達成する確率が大きく上がることが、過去30年以上の心理学研究で示されている。
依存症だけでなく、ダイエット、運動、勉強、糖尿病などの慢性疾患の管理など、幅広い分野で有効性が確認されている。
...
| もし子供を預けたあとの空白時間が始まったら | 家を出てカフェで過ごす |
| もしギャンブル系アプリを開きそうになったら | スマホを別の部屋に置いて居間で本を開く |
...
例:
- 給料日の翌日 → 朝、銀行アプリで引き出し限度額を1万円に下げる
- 夫の出張中の夜 → 18時に母にビデオ通話する
- 仕事で失敗した日 → 帰り道、駅から1駅分歩く
- 子供を預けたあとの昼間の空白時間 → 家を出てカフェか図書館で過ごす
...
- **頭の中でリハーサルすること**: 冷静なときに「もし X なら Y」を頭の中で何度も言ってみる
- **完璧でなくていい**: 最初の1つから

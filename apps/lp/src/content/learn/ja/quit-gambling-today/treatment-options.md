...
同じ悩みを持つ当事者同士のコミュニティとして、また医療機関や自助グループと並行して使うツールとして役立つ。

### QuitMate

[QuitMate](https://about.quitmate.app/) は、ギャンブルを含む各種依存症の当事者が集まるコミュニティアプリである。

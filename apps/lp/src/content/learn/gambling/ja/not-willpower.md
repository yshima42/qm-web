...
required: false
excerpt: "ギャンブルがやめられないのを「意志の弱さ」のせいにしている人は多い。本人も、家族も、ときには担当医までそう言うことがある。だが、少なくともここ十数年の医学では、その見方は正しくないとされている。"
updatedAt: "2026-04-08"
---
ギャンブルがやめられないのを「意志の弱さ」のせいにしている人は多い。本人も、家族も、ときには担当医までもがそう言うことがある。だが、少なくともここ十数年の医学では、その見方は正しくないとされている。

性格や根性の話ではなく、脳の中で起きていることの話である。そして脳の中で起きていることには、決まったパターンがある。この章ではまずそこを整理しておきたい。
...
1つ目は、ドーパミンを出す「やりたい」の回路が過剰に働くようになることだ。この回路は本来、食事・運動・人とのつながりといった生存に必要な行動を繰り返させるためのもので、ギャンブル依存になると、パチンコ店の音やスロットの絵柄に対しても、普通の人の1.5倍から2倍の強さで反応するようになる。アクセルが勝手に踏まれるような状態、と言えばわかりやすいかもしれない。
...
3つ目は、特定の場面そのものが「やりたい」の引き金になることだ。パチンコ店の音、スロット台の振動、店内の匂い、競馬中継の実況、スマホのログイン画面。こうしたものはすべて、脳にとって「報酬の合図」として強く記憶される。そしてその合図を見聞きしただけで、さきほどのアクセルが勝手に踏まれる。本人が「やめよう」と思っているかどうかは、ここでは関係がない。

この3つは別々に起きているわけではなく、同時に起きている。アクセルは強く踏まれ、ブレーキは効きが悪く、そこに合図が次々と入ってくる。そういう状態になった脳を、「やめよう」という思考だけでコントロールできるはずがない。意志の強弱で説明できる話ではないのだ。
...
最後に、本書の全体像を短く話しておきたい。本書は28章で構成されている、回復の最初の足場を作るためのガイドである。自分の状態を知ることから始まり、行動を始め、引き金に対するスキルを学び、現実と向き合い、そして立て直しを始める、という順序で進んでいく。

順番どおりに読む必要はない。必要だと感じた章から読んで構わない。ただし本書は、第1章から順に読むことで理解が少しずつ積み上がっていくように設計してある。迷っているなら、そのまま順に読み進めてほしい。

そのなかで、どうしても後回しにできない章が2つある。お金へのアクセスを遮断する話（第7章）と、「死にたい」と思ったときの安全計画（第9章）だ。いま強い危機感がある人は、先にこの2章から読むことをお勧めする。

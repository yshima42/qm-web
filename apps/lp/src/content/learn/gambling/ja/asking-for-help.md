...
1. **連絡できる人リストを作る（10分）**
   ...
   名前と連絡方法を3人以上書き出す。家族でも、友人でも、医療者でも、相談窓口でもいい。

   ```
   1. 名前: ___________ 連絡方法: ___________
   2. 名前: ___________ 連絡方法: ___________
   3. 名前: ___________ 連絡方法: ___________
   ```

2. **「最初の一言」を書く（5分）**

   上の3人それぞれに対する「最初の一言」を、本章の例から選ぶか、自分の言葉で書く。

3. **24時間以内に1行送る（時間外）**

   リストの中から1人を選び、24時間以内に1行だけメッセージを送る。
   完璧な文じゃなくていい。「相談したいことがある」だけでいい。

   送れなければ、まず「自分は今、助けを求めることが難しい状態にある」とノートに書く。
   それも一歩である。
...
- 助けを求めるのが難しいのは、依存症の症状のひとつ
- 「助けを求める」は「解決を期待する」ことではない。言葉にして渡すことが本質
- 相手は説教しない人、聞ける人を選ぶ。家族でなくてもいい
- 「最初の一言」は短くていい。完璧でなくていい
- 最初の電話は、名前 + 「困っている」 + 「初めてです」だけで十分
- 完璧な言葉・相手・タイミングを待たない。最小の一歩から始める
- 断られたら次の人に行く
- プロには遠慮しなくていい。助けを求められることが彼らの仕事

ここまでが Part 1B である。次の Part 1C では、引き金とスキルを5章にわたって扱う。次章は HALT — 空腹・怒り・孤独・疲労という4つの基本的な引き金を見ていく。

...
この利用規約（以下、「本規約」といいます。）は、禁欲メイト（以下、「運営」といいます。）がこのアプリ上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
...
禁欲メイト（以下、「本サービス」）は、児童の性的虐待や搾取（CSAE／CSAM）に該当する一切の行為およびコンテンツを明確に禁止します。

...
禁酒チャレンジ（以下、「運営」といいます。）は、本アプリ上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
...
3. 前項の委託または共同利用の対象には、以下の国に所在する事業者が含まれます。運営は、当該国の個人情報保護制度を把握した上で、安全管理措置を実施しています。
    - アメリカ合衆国
## 第6条（個人情報の開示）
...
## 第9条（個人情報の保存期間）
1. 運営は、利用目的の達成に必要な期間に限り、ユーザーの個人情報を保管します。各情報の保存期間は以下のとおりです。
    1. アカウント情報（メールアドレス、プロフィール情報、習慣記録、投稿コンテンツ、コメント等）：アカウントが有効である期間中。ユーザーがアカウントを削除した場合、運営は削除請求の受領から30日以内に当該情報を消去します。ただし、バックアップから完全に消去されるまで、さらに最大30日を要する場合があります。
    2. 認証トークンおよびセッション情報：セッション終了時または有効期限経過時に削除します。
    3. アクセスログ・サーバー操作ログ：取得から最長90日間。
    4. 利用統計・分析データ（行動ログを含む）：取得から最長14ヶ月間。これらは原則として匿名化または仮名化された形で保管されます。
    5. クラッシュレポート・エラーログ：取得から最長90日間。
    6. 課金関連情報：法令（電子帳簿保存法等）に基づき、原則として取引完了から7年間。なお、決済処理は外部の決済代行業者（Apple App Store、Google Play、RevenueCat 等）が行い、運営はクレジットカード情報を直接保有しません。
    7. 利用規約違反に関する記録：違反発生時から最大12ヶ月間。
2. ユーザーは、本アプリ内の設定画面、または info@quitmate.app 宛のメールにより、いつでもアカウントの削除を請求できます。
3. 法令により保管が義務付けられている情報については、当該義務期間が経過するまで保管します。
## 第10条（プライバシーポリシーの変更）
1. 本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく、変更することができるものとします。
2. 運営が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。
## 第11条（子どもの安全と不適切なコンテンツの防止）
